...
@app.route('/')
def index():
    return render_template('index.html', data_collection_running=data_collection_process is not None, temp_set_running=temp_set_process is not None, temp_set_collection_running=temp_set_collection_process is not None, current_temp_goal=temperature_goal)
